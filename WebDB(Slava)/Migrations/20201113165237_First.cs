        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefon = table.Column<int>(nullable: false),
                    ID_dish_1 = table.Column<long>(nullable: true),
                    ID_dish_2 = table.Column<long>(nullable: true),
                    ID_dish_3 = table.Column<long>(nullable: true),
                    IDemployees = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cost = table.Column<int>(nullable: false),
                    ID_Ingredient_1 = table.Column<long>(nullable: true),
                    ID_Ingredient_2 = table.Column<long>(nullable: true),
                    ID_Ingredient_3 = table.Column<long>(nullable: true),
                    OrderID = table.Column<long>(nullable: true),
                    OrderID1 = table.Column<long>(nullable: true),
                    OrderID2 = table.Column<long>(nullable: true),
                    OrderID3 = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Incept_date = table.Column<DateTime>(nullable: false),
